//
//  WeeklyChallengeSeeder2026W10.swift
//  Best Man Challenge
//
//  Created by Bret Clemetson on 3/12/26.
//
...
//  Best Man Challenge
//
//  Firestore-backed weekly Wordle seeder for Week 10
//

import Foundation
import FirebaseFirestore

enum WeeklyChallengeSeeder2026W10 {

    static func seedIfNeeded() async {
        let db = Firestore.firestore()
        let challengeId = "2026_w10"
        ...
        do {
            ...
            if snap.exists {
                print("ℹ️ Week 10 already exists — skipping seed.")
                return
            }

            try await createDocument(ref: ref)
            print("✅ Week 10 created (first-time only).")
