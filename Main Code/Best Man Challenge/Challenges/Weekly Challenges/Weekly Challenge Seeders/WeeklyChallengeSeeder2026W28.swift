...
//  Best Man Challenge
//
//  Week 28: World Cup Final Prop Bets
//  Dates: Jul 13–19, 2026 (picks window) | Final: July 19
...
//  ╚══════════════════════════════════════════════════════════════════╝
//
//  Props live in a SUBCOLLECTION: weekly_challenges/2026_w28/props/{propId}
//
...
enum WeeklyChallengeSeeder2026W28 {
    ...
    static func seedIfNeeded() async {
        ...
        do {
            ...
            print("✅ W28 World Cup Final Props (challenge doc) seeded.")
    ...
    private static func buildChallengeData() -> [String: Any] {
        ...
        comps.day = 20; comps.hour = 0; comps.minute = 0
        let endDate = calendar.date(from: comps)!

        return [
            "week": 28,
            "weekInt": 28,
            "title": "Week 28: World Cup Final Props",
    ...
    static func seedPropsIfNeeded(db: Firestore, challengeId: String) async {
        ...
        let props: [[String: Any]] = [
            [
                ...
                "options": [
                    ["id": "p1_a",    "position": 1, "label": "Team A (TBD)"],
                    ["id": "p1_b",    "position": 2, "label": "Team B (TBD)"],
        ...
        for prop in props {
            ...
            do {
                ...
                if snap.exists {
                    print("ℹ️ W28 prop \(propId) already exists — skipping.")
                    continue
                }
